...
import (
	...
	"github.com/shengupiao/open-ethereum-pool/proxy"
...
func startBlockUnlocker() {
	u := payouts.NewBlockUnlocker(&cfg.BlockUnlocker, cfg.Coin, backend)
	u.Start()
}
...
func main() {
	...
	backend = storage.NewRedisClient(&cfg.Redis, cfg.Coin, cfg.Pps, cfg.PartnerAddress, cfg.PartnerCommissionRate)
